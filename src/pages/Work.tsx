...
import { EditorialProjectGrid } from "../components/work/EditorialProjectGrid";
  ...
  return (
    <div ref={pageRef} className="min-h-screen overflow-x-hidden bg-bg text-text-primary">
      <Link
        ...
        className="fixed left-[var(--spacing-viewport-gutter)] top-8 z-30 inline-flex items-center gap-2 text-white mix-blend-difference md:top-10"
      >
        <LogoMark />
      ...
      {isLoading ? (
        ...
        <EditorialProjectGrid projects={projects} />
      )}
    </div>
  );
}
