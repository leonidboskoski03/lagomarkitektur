...
function PrincipleButton({
  ...
  return (
    <button
      ...
      className={[
        "flex min-h-36 flex-col justify-end border-b border-r border-black/18 p-[clamp(1rem,1.5vw,1.6rem)] text-left transition-[background-color,color] duration-700 [transition-timing-function:cubic-bezier(.58,0,.22,1)] focus-visible:z-10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-black",
        isActive
          ? "bg-brand-ink text-white"
          : "bg-white text-brand-ink hover:bg-black/[0.035]",
      ].join(" ")}
    >
      <span className="block text-[clamp(1.65rem,2.45vw,3.2rem)] font-medium leading-[0.92] tracking-[-0.058em]">
        {principle.title}
      </span>
      <span className="mt-3 max-w-[18rem] text-[0.64rem] font-semibold uppercase leading-[1.35] tracking-[0.055em] opacity-55">
        {principle.summary}
      </span>
    </button>
  );
...
function StudioPrinciplePanel({
  ...
  return (
    ...
    >
      <div
        className="flex min-h-[25rem] min-w-0 flex-col justify-between border-b border-black/18 p-[clamp(1.5rem,3vw,3.5rem)] lg:border-b-0 lg:border-r"
      >
        <p
          data-studio-principle-summary
          className="max-w-[20rem] text-[0.66rem] font-semibold uppercase leading-[1.4] tracking-[0.07em] text-black/48 will-change-[transform,opacity]"
        >
          {principle.summary}
        </p>
        ...
        <div className="mt-20 min-w-0">
          <div className="max-w-full overflow-hidden pb-[0.08em]">
            <h3
              data-studio-principle-heading
              className="whitespace-nowrap text-[clamp(3rem,12vw,4.5rem)] font-medium leading-[0.82] tracking-[-0.075em] will-change-transform lg:text-[clamp(2.5rem,3.8vw,5.2rem)]"
            >
              {principle.title}
            </h3>
          </div>
          <p
            data-studio-principle-body
            className="mt-[clamp(2rem,3.5vw,3.75rem)] max-w-[38rem] text-[clamp(1.08rem,1.35vw,1.48rem)] leading-[1.46] tracking-[-0.028em] text-black/65 will-change-[transform,opacity,filter]"
          >
            {principle.body}
          </p>
        </div>
      ...
      >
        <figure className="flex h-full flex-col p-[clamp(0.75rem,1.2vw,1.25rem)] lg:min-h-[36rem]">
          <StudioImageReveal
            ...
            className="aspect-[1.22/1] lg:min-h-0 lg:flex-1 lg:aspect-auto"
          />
